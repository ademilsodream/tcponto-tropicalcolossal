  ...
  public: {
    Tables: {
      ...
      radius_transacoes: {
        Row: {
          card: string | null
          card_embossed_detail_1: string | null
          card_embossed_detail_2: string | null
          card_embossed_detail_3: string | null
          card_fuel_type: string | null
          ...
          ev_card_sequence: string | null
          ev_end_date: string | null
          ev_start_date: string | null
